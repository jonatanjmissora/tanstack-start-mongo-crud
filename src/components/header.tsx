	...
	return (
		<header className="h-20 bg-blue-900 p-6 w-full flex justify-between gap-2">
			<nav className="flex justifi-center items-center gap-12">
				...
				<Link activeProps={{ className: "text-blue-500" }} to="/character">
					Characters
				</Link>
				<Link activeProps={{ className: "text-blue-500" }} to="/search">
					Search
				</Link>
				<Link
			...
			<nav className="flex items-center gap-2">
				{isAdmin && (
					<Link activeProps={{ className: "text-blue-500" }} to="/admin">
						Admin
					</Link>
				)}
				{isClient && (
					<Link activeProps={{ className: "text-blue-500" }} to="/client">
						Client
					</Link>
				)}
			</nav>
			...
			<div className="flex justify-center items-center gap-6">
				{!role ? (
					<Link activeProps={{ className: "text-blue-500" }} to="/login">
						Login
					</Link>
				) : (
					<button
