export function Electrodomesticos({
	electrodomesticos,
	page,
}: {
			...
			<div className="flex flex-wrap gap-8">
				{electrodomesticos.map(electrodomestico => (
					<div
						...
						className="p-4 m-4 border shadow-xl rounded-lg bg-slate-600 flex flex-col justify-center items-center gap-2"
					>
	...
	if (page) {
		...
		totalPages =
			electrodomesticos.length % electrodomesticosPerPage !== 0
				? totalPages + 1
				: totalPages
	}
