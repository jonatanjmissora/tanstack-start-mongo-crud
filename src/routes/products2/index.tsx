...
function RouteComponent() {
  ...
  <article className='flex-1 w-full p-10 '>
              ...
              <p className="text-lg font-bold mb-4">Aca lo hacemos bien, porque hacemos UN solo fetch en /products2/route.tsx que lo utilizo como loader solamente, y luego tengo el loader disponible para ambos hijos /products2/index.tsx y /products2/$product2Id.tsx </p>
