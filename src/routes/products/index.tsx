...
function RouteComponent() {
    ...
    return (
        <article className='flex-1 w-full p-10 '>
            ...
            <p className="text-lg font-bold mb-4">Aca lo hacemos mal, porque hacemos un fetch en /products/ y luego un fetch en /products/$productId para encontrar el producto y los de su categoria, estamos haciendo dos fetchs innecesarios y no utilizamos TansTack Query</p>
