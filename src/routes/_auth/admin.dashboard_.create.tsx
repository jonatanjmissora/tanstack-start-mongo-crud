...
function RouteComponent() {
  ...
  <article className='text-lg font-semibold w-1/2 p-6 bg-blue-400 text-black rounded-lg flex flex-col gap-4 justify-center'>
    ...
    <Link to={"/admin/dashboard"} search={{filter}} className="underline">Volver</Link>
    </div>
    <p>Formulario para crear elementos</p>
    <p>aca no se listan los elementos del dashboard, yo que utilice admin.dashboard_.create</p>
    </article>
)
}
