...
function RouteComponent() {
  ...
  let totalPages = 1
  if(page) {
    totalPages = Math.trunc(filteredElectrodomesticos.length/electrodomesticosPerPage)
    totalPages = filteredElectrodomesticos.length % electrodomesticosPerPage !== 0 ? totalPages + 1 : totalPages
  }
  ...
  <div className='flex flex-col gap-8'>
    ...
    <article className="flex flex-col gap-2">
      <h2>Electrodomesticos filtrados({filteredElectrodomesticos.length}) - page {page}/{totalPages}</h2>
