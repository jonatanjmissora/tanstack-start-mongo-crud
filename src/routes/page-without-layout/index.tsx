...
function RouteComponent() {
	return (
		<div className="bg-blue-500 p-20">
			<p>
				Este es el contenido de "/page-without-layout", pero como fue creado con
				"index.tsx"
			</p>
			<p>
				por mas que coloque {"<"}Outlet /{">"} no se mostrara el contenido de
